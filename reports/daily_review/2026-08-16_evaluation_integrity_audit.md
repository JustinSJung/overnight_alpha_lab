# Evaluation Integrity Audit - 2026-08-16
...
- Total evaluation rows: **59143**
- Unique evaluation keys: **5316**
- Duplicate rows by candidate key: **53827**
- Duplicate rate: **91.01%**
- Exact same-day duplicate rows: **9423**
- Same stock_code + signal_date repeated keys: **4460**
- Same candidate re-evaluated across multiple files: **4815**
...
- Benchmark-adjusted coverage: **45.43%**
- Benchmark-adjusted success rate: **51.22%**
- Benchmark rows available: **84**
- Benchmark status: **Partial**
- Latest market index file: `data/raw/market_index_20260816.csv`
