# Price Scoring Audit Report - 2026-08-13
...
| Component | Average |
|---|---:|
| final_price_signal_score_v2 | 48.80 |
| final_price_signal_score_v3 | 49.93 |
| base_momentum_score | 55.39 |
| volume_confirmation_score | -0.01 |
| volatility_penalty | 5.82 |
| overextension_penalty | 1.59 |
| reversal_risk_penalty | 1.13 |
| news_risk_penalty | 0.32 |
| attention_noise_penalty | 0.15 |
| market_regime_penalty | 0.06 |
| v3_momentum_quality_score | 44.88 |
| v3_volume_quality_score | 0.53 |
| v3_liquidity_quality_score | 3.00 |
| v3_stability_score | 8.04 |
| v3_overextension_penalty | 3.33 |
| v3_reversal_penalty | 2.75 |
