# Price Scoring Audit Report - 2026-08-12
...
- Broad candidate pool count: **269**
...
| Component | Average |
|---|---:|
| final_price_signal_score_v2 | 49.43 |
| final_price_signal_score_v3 | 48.22 |
| base_momentum_score | 56.91 |
| volume_confirmation_score | -0.45 |
| volatility_penalty | 5.89 |
| overextension_penalty | 1.73 |
| reversal_risk_penalty | 1.21 |
| news_risk_penalty | 0.33 |
| attention_noise_penalty | 0.15 |
| market_regime_penalty | 0.05 |
| v3_momentum_quality_score | 45.32 |
| v3_volume_quality_score | -0.64 |
| v3_liquidity_quality_score | 2.53 |
| v3_stability_score | 7.92 |
| v3_overextension_penalty | 3.53 |
| v3_reversal_penalty | 3.25 |
