# Price Scoring Audit Report - 2026-08-17
...
- Broad candidate pool count: **276**
...
| Component | Average |
|---|---:|
| final_price_signal_score_v2 | 49.47 |
| final_price_signal_score_v3 | 47.60 |
| base_momentum_score | 56.90 |
| volume_confirmation_score | -0.41 |
| volatility_penalty | 5.81 |
| overextension_penalty | 1.87 |
| reversal_risk_penalty | 1.12 |
| news_risk_penalty | 0.41 |
| attention_noise_penalty | 0.00 |
| market_regime_penalty | 0.06 |
| v3_momentum_quality_score | 45.06 |
| v3_volume_quality_score | -0.68 |
| v3_liquidity_quality_score | 2.33 |
| v3_stability_score | 8.01 |
| v3_overextension_penalty | 4.06 |
