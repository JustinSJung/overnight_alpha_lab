# Price Scoring Audit Report - 2026-08-10
...
- Broad candidate pool count: **248**
...
| Component | Average |
|---|---:|
| final_price_signal_score_v2 | 49.28 |
| final_price_signal_score_v3 | 43.78 |
| base_momentum_score | 57.79 |
| volume_confirmation_score | -0.42 |
| volatility_penalty | 6.00 |
| overextension_penalty | 2.70 |
| reversal_risk_penalty | 1.22 |
| news_risk_penalty | 0.43 |
| attention_noise_penalty | 0.00 |
| market_regime_penalty | 0.04 |
| v3_momentum_quality_score | 43.67 |
| v3_volume_quality_score | -0.67 |
| v3_liquidity_quality_score | 2.38 |
| v3_stability_score | 7.19 |
| v3_overextension_penalty | 5.92 |
| v3_reversal_penalty | 3.42 |
