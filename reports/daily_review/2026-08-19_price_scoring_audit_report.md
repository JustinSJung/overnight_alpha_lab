# Price Scoring Audit Report - 2026-08-19
...
- Broad candidate pool count: **293**
...
| Component | Average |
|---|---:|
| final_price_signal_score_v2 | 42.40 |
| final_price_signal_score_v3 | 43.47 |
| base_momentum_score | 49.66 |
| volume_confirmation_score | -0.53 |
| volatility_penalty | 5.79 |
| overextension_penalty | 1.30 |
| reversal_risk_penalty | 1.09 |
| news_risk_penalty | 0.35 |
| attention_noise_penalty | 0.27 |
| market_regime_penalty | 0.08 |
| v3_momentum_quality_score | 39.93 |
| v3_volume_quality_score | -0.87 |
| v3_liquidity_quality_score | 2.25 |
| v3_stability_score | 8.03 |
| v3_overextension_penalty | 2.61 |
| v3_reversal_penalty | 2.87 |
| v3_noise_penalty | 1.10 |
