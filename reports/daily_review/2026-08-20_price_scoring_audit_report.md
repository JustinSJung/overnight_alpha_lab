# Price Scoring Audit Report - 2026-08-20
...
- Broad candidate pool count: **303**
...
| Component | Average |
|---|---:|
| final_price_signal_score_v2 | 42.43 |
| final_price_signal_score_v3 | 42.99 |
| base_momentum_score | 49.84 |
| volume_confirmation_score | -0.63 |
| volatility_penalty | 5.91 |
| overextension_penalty | 1.38 |
| reversal_risk_penalty | 1.04 |
| news_risk_penalty | 0.27 |
| attention_noise_penalty | 0.28 |
| market_regime_penalty | 0.05 |
| v3_momentum_quality_score | 39.75 |
| v3_volume_quality_score | -0.79 |
| v3_liquidity_quality_score | 2.22 |
| v3_stability_score | 8.01 |
| v3_overextension_penalty | 2.92 |
| v3_reversal_penalty | 2.77 |
| v3_noise_penalty | 0.96 |
