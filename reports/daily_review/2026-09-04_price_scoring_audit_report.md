# Price Scoring Audit Report - 2026-09-04
...
- Broad candidate pool count: **529**
...
| Component | Average |
|---|---:|
| final_price_signal_score_v2 | 41.65 |
| final_price_signal_score_v3 | 44.14 |
| base_momentum_score | 48.09 |
| volume_confirmation_score | -1.73 |
| volatility_penalty | 4.60 |
| overextension_penalty | 0.95 |
| reversal_risk_penalty | 0.47 |
| news_risk_penalty | 0.17 |
| attention_noise_penalty | 0.28 |
| market_regime_penalty | 0.10 |
| v3_momentum_quality_score | 39.59 |
| v3_volume_quality_score | -3.04 |
| v3_liquidity_quality_score | 1.01 |
| v3_stability_score | 10.33 |
| v3_overextension_penalty | 1.91 |
| v3_reversal_penalty | 1.24 |
| v3_noise_penalty | 0.80 |
