# Price Scoring Audit Report - 2026-08-23
...
| Component | Average |
|---|---:|
| final_price_signal_score_v2 | 39.71 |
| final_price_signal_score_v3 | 41.22 |
| base_momentum_score | 46.78 |
| volume_confirmation_score | -0.49 |
| volatility_penalty | 5.83 |
| overextension_penalty | 1.23 |
| reversal_risk_penalty | 1.08 |
| news_risk_penalty | 0.32 |
| attention_noise_penalty | 0.19 |
| market_regime_penalty | 0.05 |
| v3_momentum_quality_score | 37.30 |
| v3_volume_quality_score | -0.81 |
| v3_liquidity_quality_score | 2.38 |
| v3_stability_score | 7.60 |
| v3_overextension_penalty | 2.30 |
| v3_reversal_penalty | 2.70 |
| v3_noise_penalty | 0.89 |
