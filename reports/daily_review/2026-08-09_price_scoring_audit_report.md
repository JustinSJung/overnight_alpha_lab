# Price Scoring Audit Report - 2026-08-09
...
- Broad candidate pool count: **240**
...
| Component | Average |
|---|---:|
| final_price_signal_score_v2 | 47.91 |
| final_price_signal_score_v3 | 44.56 |
| base_momentum_score | 56.53 |
| volume_confirmation_score | -0.81 |
| volatility_penalty | 6.04 |
| overextension_penalty | 2.16 |
| reversal_risk_penalty | 1.33 |
| news_risk_penalty | 0.42 |
| attention_noise_penalty | 0.05 |
| market_regime_penalty | 0.00 |
| v3_momentum_quality_score | 43.53 |
| v3_volume_quality_score | -1.38 |
| v3_liquidity_quality_score | 1.98 |
| v3_stability_score | 7.82 |
| v3_overextension_penalty | 4.36 |
| v3_reversal_penalty | 3.54 |
| v3_noise_penalty | 0.73 |
