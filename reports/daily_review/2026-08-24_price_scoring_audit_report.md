# Price Scoring Audit Report - 2026-08-24
...
- Broad candidate pool count: **315**
...
| Component | Average |
|---|---:|
| final_price_signal_score_v2 | 38.88 |
| final_price_signal_score_v3 | 40.44 |
| base_momentum_score | 46.24 |
| volume_confirmation_score | -0.93 |
| volatility_penalty | 5.87 |
| overextension_penalty | 1.21 |
| reversal_risk_penalty | 1.05 |
| news_risk_penalty | 0.30 |
| attention_noise_penalty | 0.00 |
| market_regime_penalty | 0.05 |
| v3_momentum_quality_score | 36.99 |
| v3_volume_quality_score | -1.65 |
| v3_liquidity_quality_score | 1.90 |
| v3_stability_score | 8.21 |
| v3_overextension_penalty | 2.43 |
| v3_reversal_penalty | 2.88 |
| v3_noise_penalty | 0.55 |
