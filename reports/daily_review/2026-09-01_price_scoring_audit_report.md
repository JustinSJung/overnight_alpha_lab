# Price Scoring Audit Report - 2026-09-01
...
- Broad candidate pool count: **432**
...
| Component | Average |
|---|---:|
| final_price_signal_score_v2 | 44.27 |
| final_price_signal_score_v3 | 45.69 |
| base_momentum_score | 51.54 |
| volume_confirmation_score | -1.50 |
| volatility_penalty | 4.87 |
| overextension_penalty | 1.38 |
| reversal_risk_penalty | 0.57 |
| news_risk_penalty | 0.24 |
| attention_noise_penalty | 0.56 |
| market_regime_penalty | 0.16 |
| v3_momentum_quality_score | 42.12 |
| v3_volume_quality_score | -2.74 |
| v3_liquidity_quality_score | 1.24 |
| v3_stability_score | 9.88 |
| v3_overextension_penalty | 2.39 |
| v3_reversal_penalty | 1.67 |
| v3_noise_penalty | 1.45 |
