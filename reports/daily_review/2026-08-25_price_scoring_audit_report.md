# Price Scoring Audit Report - 2026-08-25
...
- Broad candidate pool count: **320**
...
| Component | Average |
|---|---:|
| final_price_signal_score_v2 | 41.04 |
| final_price_signal_score_v3 | 42.72 |
| base_momentum_score | 48.72 |
| volume_confirmation_score | -0.97 |
| volatility_penalty | 5.85 |
| overextension_penalty | 1.25 |
| reversal_risk_penalty | 1.09 |
| news_risk_penalty | 0.30 |
| attention_noise_penalty | 0.26 |
| market_regime_penalty | 0.02 |
| v3_momentum_quality_score | 39.74 |
| v3_volume_quality_score | -1.86 |
| v3_liquidity_quality_score | 1.77 |
| v3_stability_score | 8.34 |
| v3_overextension_penalty | 2.48 |
| v3_reversal_penalty | 2.90 |
