# Price Scoring Audit Report - 2026-09-02
...
- Broad candidate pool count: **479**
...
| Component | Average |
|---|---:|
| final_price_signal_score_v2 | 43.08 |
| final_price_signal_score_v3 | 45.57 |
| base_momentum_score | 49.70 |
| volume_confirmation_score | -1.71 |
| volatility_penalty | 4.63 |
| overextension_penalty | 0.94 |
| reversal_risk_penalty | 0.47 |
| news_risk_penalty | 0.14 |
| attention_noise_penalty | 0.56 |
| market_regime_penalty | 0.10 |
| v3_momentum_quality_score | 41.01 |
| v3_volume_quality_score | -3.02 |
| v3_liquidity_quality_score | 1.01 |
| v3_stability_score | 10.37 |
| v3_overextension_penalty | 1.77 |
| v3_reversal_penalty | 1.26 |
| v3_noise_penalty | 1.17 |
