# Price Scoring Audit Report - 2026-09-03
...
- Broad candidate pool count: **510**
...
| Component | Average |
|---|---:|
| final_price_signal_score_v2 | 41.07 |
| final_price_signal_score_v3 | 43.42 |
| base_momentum_score | 47.46 |
| volume_confirmation_score | -1.70 |
| volatility_penalty | 4.59 |
| overextension_penalty | 0.92 |
| reversal_risk_penalty | 0.48 |
| news_risk_penalty | 0.16 |
| attention_noise_penalty | 0.36 |
| market_regime_penalty | 0.08 |
| v3_momentum_quality_score | 38.81 |
| v3_volume_quality_score | -3.04 |
| v3_liquidity_quality_score | 1.04 |
| v3_stability_score | 10.25 |
| v3_overextension_penalty | 1.86 |
| v3_reversal_penalty | 1.29 |
| v3_noise_penalty | 0.88 |
