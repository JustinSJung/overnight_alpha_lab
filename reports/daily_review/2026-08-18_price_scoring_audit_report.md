# Price Scoring Audit Report - 2026-08-18
...
- Broad candidate pool count: **286**
...
| Component | Average |
|---|---:|
| final_price_signal_score_v2 | 45.61 |
| final_price_signal_score_v3 | 47.08 |
| base_momentum_score | 51.96 |
| volume_confirmation_score | 0.08 |
| volatility_penalty | 5.80 |
| overextension_penalty | 1.33 |
| reversal_risk_penalty | 1.18 |
| news_risk_penalty | 0.39 |
| attention_noise_penalty | 0.00 |
| market_regime_penalty | 0.08 |
| v3_momentum_quality_score | 41.78 |
| v3_volume_quality_score | 0.69 |
| v3_liquidity_quality_score | 3.07 |
| v3_stability_score | 7.45 |
| v3_overextension_penalty | 2.79 |
| v3_reversal_penalty | 2.92 |
| v3_noise_penalty | 0.71 |
