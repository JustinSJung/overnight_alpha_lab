# Price Scoring Audit Report - 2026-08-28
...
- Broad candidate pool count: **326**
...
| Component | Average |
|---|---:|
| final_price_signal_score_v2 | 48.09 |
| final_price_signal_score_v3 | 46.80 |
| base_momentum_score | 55.36 |
| volume_confirmation_score | -0.91 |
| volatility_penalty | 5.32 |
| overextension_penalty | 2.06 |
| reversal_risk_penalty | 0.73 |
| news_risk_penalty | 0.33 |
| attention_noise_penalty | 0.01 |
| market_regime_penalty | 0.01 |
| v3_momentum_quality_score | 43.09 |
| v3_volume_quality_score | -1.62 |
| v3_liquidity_quality_score | 1.87 |
| v3_stability_score | 9.24 |
| v3_overextension_penalty | 3.83 |
| v3_reversal_penalty | 2.21 |
| v3_noise_penalty | 0.57 |
