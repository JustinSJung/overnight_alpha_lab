# Price Scoring Audit Report - 2026-08-27
...
- Broad candidate pool count: **323**
...
| Component | Average |
|---|---:|
| final_price_signal_score_v2 | 45.49 |
| final_price_signal_score_v3 | 44.78 |
| base_momentum_score | 52.96 |
| volume_confirmation_score | -1.15 |
| volatility_penalty | 5.39 |
| overextension_penalty | 1.90 |
| reversal_risk_penalty | 0.70 |
| news_risk_penalty | 0.31 |
| attention_noise_penalty | 0.08 |
| market_regime_penalty | 0.00 |
| v3_momentum_quality_score | 41.66 |
| v3_volume_quality_score | -2.21 |
| v3_liquidity_quality_score | 1.54 |
| v3_stability_score | 9.29 |
| v3_overextension_penalty | 3.46 |
| v3_reversal_penalty | 2.23 |
| v3_noise_penalty | 0.64 |
