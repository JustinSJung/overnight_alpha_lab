# Price Scoring Audit Report - 2026-07-28
...
- Broad candidate pool count: **181**
...
| Component | Average |
|---|---:|
| final_price_signal_score_v2 | 37.62 |
| base_momentum_score | 44.00 |
| volume_confirmation_score | -0.23 |
| volatility_penalty | 5.92 |
| overextension_penalty | 0.47 |
| reversal_risk_penalty | 1.40 |
| news_risk_penalty | 0.17 |
| attention_noise_penalty | 0.35 |
| market_regime_penalty | 0.12 |
