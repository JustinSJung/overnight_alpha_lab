# Model Performance History Report - 2026-08-18
...
- ML dataset rows: **4227**
- Error-note rows: **1030**
- Market-adjusted evaluation rows: **987**
- Market-adjusted score rows: **987**
- Trading volume score rows: **8296**

- Prediction success: **0**
- Prediction failure: **0**
- Prediction pending: **1030**
...
| convertible_bond | 154 | 0 | 0 | 154 | 0 | 0.00% |
...
| major_shareholder_change | 282 | 0 | 0 | 282 | 0 | 0.00% |
| merger | 46 | 0 | 0 | 46 | 0 | 0.00% |
| paid_in_capital_increase | 166 | 0 | 0 | 166 | 0 | 0.00% |
| spin_off | 9 | 0 | 0 | 9 | 0 | 0.00% |
| supply_contract | 152 | 0 | 0 | 152 | 0 | 0.00% |
