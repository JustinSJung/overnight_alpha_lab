# Price Scoring Audit Report - 2026-08-07
...
| Component | Average |
|---|---:|
| final_price_signal_score_v2 | 46.44 |
| final_price_signal_score_v3 | 43.62 |
| base_momentum_score | 55.49 |
| volume_confirmation_score | -1.40 |
| volatility_penalty | 6.02 |
| overextension_penalty | 1.76 |
| reversal_risk_penalty | 1.17 |
| news_risk_penalty | 0.40 |
| attention_noise_penalty | 0.24 |
| market_regime_penalty | 0.00 |
| v3_momentum_quality_score | 43.89 |
| v3_volume_quality_score | -2.56 |
| v3_liquidity_quality_score | 1.31 |
| v3_stability_score | 7.93 |
| v3_overextension_penalty | 3.63 |
| v3_reversal_penalty | 3.02 |
| v3_noise_penalty | 0.99 |
