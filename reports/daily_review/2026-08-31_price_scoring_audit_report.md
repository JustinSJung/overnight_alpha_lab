# Price Scoring Audit Report - 2026-08-31
...
| Component | Average |
|---|---:|
| final_price_signal_score_v2 | 44.97 |
| final_price_signal_score_v3 | 45.47 |
| base_momentum_score | 52.53 |
| volume_confirmation_score | -1.52 |
| volatility_penalty | 4.93 |
| overextension_penalty | 1.35 |
| reversal_risk_penalty | 0.57 |
| news_risk_penalty | 0.25 |
| attention_noise_penalty | 0.69 |
| market_regime_penalty | 0.19 |
| v3_momentum_quality_score | 42.80 |
| v3_volume_quality_score | -2.79 |
| v3_liquidity_quality_score | 1.19 |
| v3_stability_score | 9.62 |
| v3_overextension_penalty | 2.53 |
| v3_reversal_penalty | 1.68 |
| v3_noise_penalty | 1.68 |
