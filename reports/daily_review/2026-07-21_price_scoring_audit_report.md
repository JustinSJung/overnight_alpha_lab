...
| Component | Average |
|---|---:|
| final_price_signal_score_v2 | 32.56 |
| base_momentum_score | 40.81 |
| volume_confirmation_score | -1.32 |
| volatility_penalty | 6.11 |
| overextension_penalty | 0.72 |
| reversal_risk_penalty | 1.34 |
| news_risk_penalty | 0.55 |
