...
- Broad candidate pool count: **108**
...
| Component | Average |
|---|---:|
| final_price_signal_score_v2 | 32.58 |
| base_momentum_score | 40.84 |
| volume_confirmation_score | -1.37 |
| volatility_penalty | 6.10 |
| overextension_penalty | 0.73 |
| reversal_risk_penalty | 1.37 |
